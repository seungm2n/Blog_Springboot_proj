...
public class UserController {
    ...
    public String kakaoCallback(String code) {
        ...
        HttpEntity<MultiValueMap<String, String>> kakaoTokenProfileRequest2 =
        ...
        System.out.println("블로그 서버 네임 : " + kakaoProfile.getKakao_account().getEmail() + kakaoProfile.getId());
